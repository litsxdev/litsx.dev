...
const categories = [
  ...
  {
    title: "Structural Hooks And Host Middleware",
    intro: "These APIs define the public structural-hook authoring contract and the host middleware runtime surface used by compiled structural entries.",
    declarations: indexDeclarations,
    names: [
